...
[`RT/make_rt_inelastic_figures.py`](RT/make_rt_inelastic_figures.py); the
numbers quoted below are in [`RT/rt_inelastic_metrics.csv`](RT/rt_inelastic_metrics.csv).
...
![Size of each inelastic process in the L23 truth](RT/fig_l23_inelastic_impact.png)
...
![Raman coefficient and redistribution](RT/fig_raman_redistribution.png)
...
![BING Raman correction vs L23](RT/fig_raman_bing_vs_l23.png)

Median error on the Raman *increment* (factor − 1), from
`RT/rt_inelastic_metrics.csv`:
...
![BING fluorescence vs L23](RT/fig_fluor_bing_vs_l23.png)
