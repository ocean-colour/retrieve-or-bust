<!-- GENERATED FILE -- do not edit.
     Written by docs/figures/make_docs_figures.py from reports/report_rt_inelastic_model.md.
...
:::{note}
This page is a verbatim copy of [`reports/report_rt_inelastic_model.md`](https://github.com/ocean-colour/retrieve-or-bust/blob/main/reports/report_rt_inelastic_model.md), the team report as it was
...
[`make_inelastic_report_figures.py`](https://github.com/ocean-colour/retrieve-or-bust/blob/main/reports/make_inelastic_report_figures.py) from the
committed validation artefacts in [`design/validation/`](https://github.com/ocean-colour/retrieve-or-bust/tree/main/design/validation).
...
> treatment is
> [`docs/model/cdom_fluorescence.md`](https://github.com/ocean-colour/retrieve-or-bust/blob/main/docs/model/cdom_fluorescence.md).
...
[`context/RT/rt_inelastic_bing_summary.md`](https://github.com/ocean-colour/retrieve-or-bust/blob/main/context/RT/rt_inelastic_bing_summary.md).
...
The design ([`design/rt_inelastic_model.md`](https://github.com/ocean-colour/retrieve-or-bust/blob/main/design/rt_inelastic_model.md))
...
![The composed forward-model architecture](../_static/fig_inelastic_architecture.png)
...
400–700 nm
([`design/validation/metrics_inelastic.md`](https://github.com/ocean-colour/retrieve-or-bust/blob/main/design/validation/metrics_inelastic.md)):
...
![Per-wavelength total rRMS vs X4 for the three models](../_static/fig_inelastic_rrms_ladder.png)
...
![Per-process deltas, analytic backbone to corrected](../_static/fig_inelastic_deltas.png)
...
![The zenith-holdout cliff](../_static/fig_inelastic_unseen_zenith.png)
...
1. **Geometry coverage is now the binding limitation** — it caps both the
   ...
   ([`design/rt_inelastic_model.md`](https://github.com/ocean-colour/retrieve-or-bust/blob/main/design/rt_inelastic_model.md) §8)
...
2. **CDOM fluorescence** — the third inelastic process — *(updated
   ...
   [`docs/model/cdom_fluorescence.md`](https://github.com/ocean-colour/retrieve-or-bust/blob/main/docs/model/cdom_fluorescence.md)
   and
   [`design/rt_inelastic_implementation.md`](https://github.com/ocean-colour/retrieve-or-bust/blob/main/design/rt_inelastic_implementation.md)
   §8.
...
| document | role |
|---|---|
| [`context/RT/rt_inelastic_bing_summary.md`](https://github.com/ocean-colour/retrieve-or-bust/blob/main/context/RT/rt_inelastic_bing_summary.md) | the assessment: BING's inelastic RT quantified against L23 |
| [`design/rt_inelastic_model.md`](https://github.com/ocean-colour/retrieve-or-bust/blob/main/design/rt_inelastic_model.md) | the design (what/why), incl. the HydroLight wishlist (§8) |
| [`design/rt_inelastic_model_coding_plan.md`](https://github.com/ocean-colour/retrieve-or-bust/blob/main/design/rt_inelastic_model_coding_plan.md) | milestones M0–M4 (how/when) |
| [`design/rt_inelastic_implementation.md`](https://github.com/ocean-colour/retrieve-or-bust/blob/main/design/rt_inelastic_implementation.md) | what was actually built, per milestone |
| `claude_prompts/RT/rt_inelastic_coding_prompt_{1..5}.md` | the execution prompts and their dated logs |
| [`design/rt_cdom_fluorescence_model.md`](https://github.com/ocean-colour/retrieve-or-bust/blob/main/design/rt_cdom_fluorescence_model.md) | the CDOM-fluorescence (M5/M6) design — postdates v1.0 (Addendum) |
| `claude_prompts/RT/rt_cdom_coding_prompt_1.md` | the M5 execution prompt and its dated logs |
| [`docs/model/cdom_fluorescence.md`](https://github.com/ocean-colour/retrieve-or-bust/blob/main/docs/model/cdom_fluorescence.md) | the maintained CDOM-fluorescence chapter — the term this report predates |
